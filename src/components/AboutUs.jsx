        ...
        <div className="flex flex-col w-full lg:flex-row h-full lg:h-screen items-center lg:items-start justify-center mt-[50px] lg:mt-[150px]">
            <div className='flex w-full lg:w-11/12'>
                ...
                <span className="flex justify-center lg:justify-start w-full lg:w-4/5 px-[30px] lg:px-0">
                    <div className="flex flex-col justify-between items-between text-justify my-0 lg:my-0">
                        <p className="md:mr-[50px] lg:mr-[100px] xl:mr-[150px] text-10 lg:text-16 max-w-[450px]">
                        ...
                        <p className="mx-[30px] lg:mr-[150px] hidden lg:block self-end lg:self-center text-16 max-w-[450px] my-foko">
                        ...
                        <h2 className="hidden lg:flex font-rubik max-w-[450px] text-10 lg:text-20 cursor-pointer my-[50px] lg:my-0">
                            MORE &nbsp; &nbsp; &nbsp;
                            <img src={right} alt="Right Image" />
                        </h2>
                        <h2 className="block lg:hidden flex font-rubik max-w-[450px] text-10 lg:text-20 cursor-pointer my-[50px] lg:my-0">
                            MORE &nbsp; &nbsp; &nbsp;
