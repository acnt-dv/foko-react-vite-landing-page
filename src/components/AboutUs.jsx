...
const AboutUs = () => {
    return (
        <div className="flex flex-col md:flex-row h-full md:h-screen items-start justify-center mt-[150px]">
            <div className='flex'>
                ...
                <div className="flex flex-col justify-start items-center text-justify my-0 md:my-0">
                    <p className="mx-[30px] md:mr-[150px] text-10 md:text-16 w-7/12 self-end md:self-center max-w-[450px] mt-foko">
                    ...
                    <p className="mx-[30px] md:mr-[150px] hidden md:block w-7/12 self-end md:self-center text-16 max-w-[450px] my-foko">
                    ...
                    <h2 className="flex font-rubik w-7/12 max-w-[450px] self-end md:self-center mx-[30px] md:mr-[150px] md:justify-self-start text-10 md:text-20 mt-foko cursor-pointer">
                        MORE &nbsp; &nbsp; &nbsp;
