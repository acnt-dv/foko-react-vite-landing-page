...
const AboutUs = () => {
    ...
    return (
        <div className="flex flex-col w-full lg:flex-row h-full lg:h-screen items-center lg:items-start justify-end mt-[5.92vh] lg:mt-[18.52vh]">
            <div className='flex w-full'>
                <span className="flex justify-center lg:justify-start w-full">
                    <div className="flex w-full flex-col justify-end items-end text-justify my-0">
                        <span className="flex">
                        <h1 className="flex w-fit lg:hidden text-16 font-rubik text-end">ABOUT <br /> FOKO</h1>
                        <p className="w-[59.23vw] ml-[15.63vw] mr-[7.69vw] lg:mr-[7.81vw] text-[clamp(10px,0.83vw,16px)] text-justify leading-loose tracking-[0.015em]">
                        ...
                        <h2 className="hidden lg:flex font-rubik w-full ml-[15.63vw] lg:text-20 cursor-pointer lg:my-0" onClick={() => { navigate('/contactUs') }}>
                            MORE &nbsp; &nbsp; &nbsp;
