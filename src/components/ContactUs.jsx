const ContactUs = () => {
    return (
        <div className="flex w-full md:max-w-11/12 flex-col md:flex-row w-full h-full md:h-screen justify-start items-start mb-32">
            ...
            <span className="flex w-full md:w-4/5">
                <div className='flex w-full text-justify items-start'>
                    ...
                    <div className="col">
                        ...
                        <p className="mt-[50px] md:mt-[100px] text-10 md:text-16">Pegah Koulaeian</p>
                        <p className="text-10 md:text-16">pegah@fokostudio.com</p>
                        <p className="text-10 md:text-16">949-502-1482</p>
                        <p className="mt-[50px] text-10 md:text-16">Jenny Fontenot</p>
