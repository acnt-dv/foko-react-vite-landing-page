...
const FullPageMenu = ({isOpen, onClose}) => {
    ...
    return (
        <div
            ...
            <button onClick={onClose} className="absolute top-[37.5px] right-[30px] md:top-[72.5px] md:right-[50px] cursor-pointer">
                <img src={close} alt="close" width='30px' height='30px'/>
            </button>

            <div className="flex flex-col md:flex-row w-full items-center justify-center">
                <span className='flex w-1/2 justify-center items-center m-[50px]'>
                    <img src={logo} alt={'logo'} className='w-[75px] h-[75px] md:w-[130px] md:h-[130px] filter brightness-0 invert'/>
                </span>
