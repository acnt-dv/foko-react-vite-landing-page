                ...
                <div className="flex mt-[3.55vh] lg:mt-[12.04vh]">
                    <div className="relative w-[25.64vw] lg:w-[6.77vw]">
                        <input
                            ...
                            className="w-full text-[clamp(10px,1.60vw,16px)] lg:text-[clamp(10px,1.04vw,20px)] leading-none block font-rubik cursor-pointer bg-transparent pr-0 focus:outline-none focus:ring-0"
                        />
                        <button
                            onClick={() => {
                                if (password === "HelloFOKO23") {
