            ...
            <div className="flex flex-col lg:flex-row w-10/12">
                <div className="relative w-full h-full aspect-[1/1.5] lg:w-1/3 lg:max-w-[528px] lg:max-h-[698px] flex flex-col items-center">
                    ...
                    <img
                        src={profileImage}
                        alt="Jenny Fontenot"
                        className="absolute m-0 lg:ml-[-25px] top-0 left-0 w-full h-full object-cover shadow-lg"
                    />
                </div>

                <div className="relative w-full lg:w-2/3 px-0 my-[30px] lg:my-0 lg:pl-[50px] flex flex-col justify-between">
                    <div>
                        {/* Name and Title */}
