    ...
    return (
        ...
        <div className="flex bg-foko min-h-full md:w-full mt-[125px] justify-end">
            <div className="flex flex-col md:flex-row w-10/12">
                ...
                <div className="relative w-full md:w-2/3 px-0 my-[30px] md:my-0 md:pl-[50px] flex-col justify-items-start">
                    {/* Name and Title */}
                    ...
                    <div className='absolute left-[15px] bottom-[-10px]'>
                        <div className="flex flex-row justify-between items-end w-full px-6">
                            ...
                            <div className="text-left mb-[10px] mr-[40px] text-[12px] leading-[1.8]">
                                <div className="grid grid-cols-2 gap-x-4 gap-y-1 p-2 w-full">
