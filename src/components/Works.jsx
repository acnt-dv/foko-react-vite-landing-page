...
[Your Firm’s Name], we believe in the power of collaboration and creativity. Our project`
    ...
    return (
        <div className="flex flex-col w-full bg-foko">
            ...
            <div className="flex w-full mx-0 items-start justify-center md:justify-start text-black">
                <div className="flex items-start mt-[30px] md:mt-[50px] md:w-1/5">
                    {/* <p className="mt-[30px] md:mt-[160px] mx-[30px] md:mx-0 md:absolute md:left-[50px] font-rubik text-10 md:text-30 text-end break-words -translate-y-1/2 text-gray-900 transition-transform duration-300" style={{transform: `translateY(${translateY}px)`,}}*/}
                    <p className='mx-[30px] md:mx-foko font-rubik text-16 md:text-30 text-end break-words mt-[-4px] md:mt-[-10px]'>
                ...
                <div className="flex-col w-3/5 space-y-16 items-center justify-end mr-[30px] md:mr-0 text-black mb-[150px]">
                    ...
                    <p className='text-justify mt-[30px] md:mt-[50px] text-10 md:text-16'>
                        {textLines}
                    </p>
                    <MiniSlideShow />
                </div>
